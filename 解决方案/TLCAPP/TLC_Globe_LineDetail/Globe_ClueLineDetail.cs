...
{
    public class Globe_ClueLineDetail : Globe_ClueBase
    {             
        #region 静态方法

        public static Globe_ClueLineDetail GetBase(Globe_Clue item)
        {
            Globe_ClueLineDetail model = null;
            try
            {
                model = new Globe_ClueLineDetail()
                {
                    Id = item.Id,
                    Code = item.Code,
