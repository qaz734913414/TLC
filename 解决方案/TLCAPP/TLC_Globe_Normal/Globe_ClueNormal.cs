...
{
    public class Globe_ClueNormal : Globe_ClueBase
    {             
        #region 静态方法

        public static Globe_ClueNormal GetBase(Globe_Clue item)
        {
            Globe_ClueNormal model = null;
            try
            {
                model = new Globe_ClueNormal()
                {
                    Id = item.Id,
                    Code = item.Code,
