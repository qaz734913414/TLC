...
{
    public class Globe_ClueLineAnimal : Globe_ClueBase
    {             
        #region 静态方法

        public static Globe_ClueLineAnimal GetBase(Globe_Clue item)
        {
            Globe_ClueLineAnimal model = null;
            try
            {
                model = new Globe_ClueLineAnimal()
                {
                    Id = item.Id,
                    Code = item.Code,
